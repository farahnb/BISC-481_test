...
library(caret)
library(ROCR)
workingPath <- "/Users/farahnajib/Downloads/BISC481-master/CTCF/"
## I had to update the working path above so that it would work for me

## Generate data for the classifcation (assign Y to bound and N to non-bound)
# bound
boundFasta <- readDNAStringSet(paste0(workingPath, "bound_30.fa")) ## we kept it at 30 because at 500 it would take to long to run
